...
import { statusOptionsBase } from "../../../constants/products";
...
const getColumns = (onActionClick, currentPage, pageSize) => [
  {
    title: "STT",
    fixed: "left",
    align: "center",
  ...
  },
  {
    ...
    align: "center",
    render: (item) => {
      const statusItem = _.find(statusOptionsBase, (i) => i.value === item);
      const color = {
        active: "#1677ff",
        inactive: "#faad14",
        discontinued: "#ff4d4f",
